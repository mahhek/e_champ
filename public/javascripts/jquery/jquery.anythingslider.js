...
(function($) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.init = function(){
			...
			base.slideshow = true; // slideshow flag
		...
		base.buildNextBackButtons = function() {
			...
			base.$forward = $('<div style="float: right;" class="arrow_settings"><span class="arrow forward"><a href="#"><span>' + base.options.forwardText + '</span></a></span></div>');
			base.$back = $('<div class="arrow_settings"><span class="arrow back"><a href="#"><span>' + base.options.backText + '</span></a></span></div>');
